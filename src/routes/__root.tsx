...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Loja de tecnologia com smartphones, TVs, notebooks e casa inteligente." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Nova Store | Tecnologia e eletrônicos premium" },
      { property: "og:description", content: "Loja de tecnologia com smartphones, TVs, notebooks e casa inteligente." },
