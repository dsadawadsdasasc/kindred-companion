    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b border-border/60">
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute -bottom-40 -left-20 h-[380px] w-[380px] rounded-full bg-accent/20 blur-[120px]"
          />
          <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:py-28">
            <div>
              ...
              <p className="mt-6 max-w-lg text-base text-muted-foreground">
                Smartphones, TVs, notebooks e casa inteligente selecionados. Compre em poucos
                cliques com checkout seguro e frete expresso.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {CATEGORIES.slice(0, 4).map((c) => (
                <Link
                  ...
                  to="/categoria/$slug"
                  params={{ slug: c.slug }}
                  className="rounded-2xl border border-border/70 bg-card/70 p-5 backdrop-blur transition-colors hover:border-primary/50"
                >
        ...
        <section className="border-b border-border/60 bg-card/30">
          <div className="mx-auto grid max-w-7xl gap-6 px-4 py-8 sm:px-6 md:grid-cols-4">
            {BENEFITS.map((b) => (
        ...
        {/* Categorias */}
        <section id="categorias" className="mx-auto max-w-7xl px-4 pt-16 sm:px-6">
        ...
        <section id="produtos" className="relative mx-auto mt-16 max-w-7xl px-4 sm:px-6">
          <div className="relative overflow-hidden rounded-3xl border border-[#ff1030]/50 bg-[#150004]">
            ...
            <div className="relative grid items-center gap-8 p-8 sm:p-12 lg:grid-cols-2">
              <div>
                <span className="inline-flex items-center gap-2 rounded-full border border-[#ff2d55]/60 bg-[#ff0033]/15 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-[#ff5470] shadow-[0_0_24px_rgba(255,0,51,0.45)]">
                  Pré-venda exclusiva
                </span>
                <h2 className="mt-6 text-4xl font-bold leading-[1.05] text-white sm:text-6xl">
                  iPhone 18 Pro Max
                  <br />
                ...
                <p className="mt-5 max-w-lg text-lg font-medium text-[#ffb3c1]">
                ...
                <p className="mt-4 text-xs uppercase tracking-widest text-[#ff5470]">
              ...
              <div className="relative flex justify-center">
                ...
                <img
                  ...
                  width={1024}
                  height={1024}
                  className="relative w-full max-w-md drop-shadow-[0_0_60px_rgba(255,0,51,0.55)]"
                />
              </div>
            </div>
          </div>
